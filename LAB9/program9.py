'''9. Standard I/O Redirection: Write a shell script that demonstrates input
and output redirection. Create a script that reads from a file and writes
output to another file using redirection operators (>, >>, <).'''
#!/bin/bash
