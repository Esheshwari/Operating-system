'''10. Piping Commands: Develop a shell script that uses pipes to connect
multiple commands. For example, use grep to filter output from ls and
sort the results. add 3. opt to search specific file'''
#!/bin/bash
...
while true; do
    ...
    case $option in
        ...
        4) echo "Exiting the Piping Commands Manager. Goodbye!"; exit 0 ;;
